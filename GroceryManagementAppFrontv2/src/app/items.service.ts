...
export class ItemsService {
  ...
  listAllItems(): Observable<Item[]> {
    this.items = this.http
      .get<Item[]>(this.BASE_URL + '/listAllItems')
  ...
  deleteItem(item: Item): Observable<{}> {
    ...
    const response = this.http
      .delete(this.BASE_URL + '/deleteItem/' + item.id, this.httpOptions)
      .pipe(
  ...
  addItem(item: Item): Observable<{}> {
    const response = this.http
      .post(this.BASE_URL + '/createItem/', item, this.httpOptions)
      .pipe(
        // tap(_ => this.log(`deleted item id=${item.id}`)),
  ...
  updateItem(item: Item) {
    const response = this.http
      .put(this.BASE_URL + '/updateItem/' + item.id, item, this.httpOptions)
      .pipe(
        // tap(_ => this.log(`deleted item id=${item.id}`)),
